        ...
        <ul class="nav">
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/ecommerce/ecommerce2.html">dashboard 2</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/apps/email/read.html">Read</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/apps/todolist/add-new.html">add new</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/apps/invoice/invoice-details.html">details</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/apps/project-manager/task-list.html">task list</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/apps/file-manager/share.html">share</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/ui-elements/icons/materializeicon.html">Materialize Icons</a>
                    </li>
                    <li>
                        <a href="pages/ui-elements/icons/et-lineicon.html">Et-Line Icons</a>
                    </li>
                    <li>
                        <a href="pages/ui-elements/icons/eleganticon.html">Elegant Icons</a>
                    </li>
                    <li>
                        <a href="pages/ui-elements/icons/pe-7strokeicon.html">Pe-7 Stroke Icons</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/form&table/form-elements/input-group.html">Input Groups</a>
                    </li>
                    <li>
                        <a href="pages/form&table/form-elements/checkbox.html">Checkbox</a>
                    </li>
                    <li>
                        <a href="pages/form&table/form-elements/radio.html">radio</a>
                    </li>
                    <li>
                        <a href="pages/form&table/form-elements/switch.html">Switch</a>
                    </li>
                    <li>
                        <a href="pages/form&table/form-elements/number-input.html">Number Input</a>
                    </li>
                    <li>
                        <a href="pages/form&table/form-elements/textarea.html">Text Area</a>
                    </li>
                    <li>
                        <a href="pages/form&table/form-elements/text-editor.html">Text Editor (Quill Editor)</a>
                    </li>
                    <li>
                        <a href="pages/form&table/form-elements/file-uploader.html">File Uploader</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/pages/user-profile/about.html">about</a>
                    </li>
                    <li>
                        <a href="pages/pages/user-profile/gallery.html">gallery</a>
                    </li>
                    <li>
                        <a href="pages/pages/user-profile/connection.html">Connections</a>
                    </li>
                    <li>
                        <a href="pages/pages/user-profile/profile-chat.html">Chat</a>
                    </li>
                    <li>
                        <a href="pages/pages/user-profile/edit-profile.html">Edit Profile</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/pages/authentication/register.html">Register</a>
                    </li>
                    <li>
                        <a href="pages/pages/authentication/forget-pass.html">Forget Password</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/pages/miscellaneous/404.html">404 Error</a>
                    </li>
                    <li>
                        <a href="pages/pages/miscellaneous/500.html">500 Error</a>
                    </li>
                    <li>
                        <a href="pages/pages/miscellaneous/page-not-authorized.html">Not Authorized</a>
                    </li>
                    <li>
                        <a href="pages/pages/miscellaneous/maintenance.html">Maintenance</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-menu">
                    ...
                    <li>
                        <a href="pages/charts/morrischart.html">Morris Chart</a>
                    </li>
                    <li>
                        <a href="pages/charts/flotchart.html">Flot Chart</a>
                    </li>
                    <li>
                        <a href="pages/charts/chartist.html">Chartist Chart</a>
                    </li>
                    <li>
            ...
            <li>
                <a href="{{route('admin.equipments.index')}}">
                    <i class="icofont-drag"></i>
                    <span class="link-title">Оборудования</span>
                </a>
            </li>
            <li>
